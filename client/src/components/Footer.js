    ...
    <>
      <footer className="footer">
        ...
        <div className="footer-bottom">
          ...
          <span style={{ marginTop: '0.5rem', fontSize: '0.8rem', color: 'var(--gray)' }}>تصميم وتطوير: <a href="https://alghithapp.netlify.app/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary-light)', fontWeight: '600' }}>الغيث لتصميم التطبيقات والأنظمة</a></span>
        </div>
      </footer>
